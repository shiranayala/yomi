...
export const Icon = {
  ...
  arrowR:         (p: IconProps) => svg(<><line x1="5" y1="12" x2="19" y2="12"/><polyline points="14 6 20 12 14 18"/></>, p),
  cloud:          (p: IconProps) => svg(<path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9z"/>, p),
  cloudSun:       (p: IconProps) => svg(<><path d="M12 2v2m-7.07 2.93 1.41 1.41M20 12h2m-4.93-7.07-1.41 1.41"/><path d="M15.947 12.65a4 4 0 0 0-5.925-4.128"/><path d="M13 22H7a5 5 0 1 1 4.9-6H13a3 3 0 0 1 0 6z"/></>, p),
  cloudRain:      (p: IconProps) => svg(<><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M16 14v6M8 14v6M12 16v6"/></>, p),
